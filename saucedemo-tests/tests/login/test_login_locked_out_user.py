...
def test_login_locked_out_user(driver, config):
    username = "locked_out_user"
    password = config['password']
    
    logging.info("----- Starting Test L2: Login with locked-out user -----")
    ...
    try:
        ...
        # Step 2: Enter valid username for locked-out user
        ...
        # Step 5: Verify error message for locked-out user
        logging.info("Step 5: Verifying error message for locked-out user")
        ...
        logging.info("Error message for locked-out user displayed as expected.")
        ...
        logging.info("----- End of Test L2: Login with locked-out user -----")
